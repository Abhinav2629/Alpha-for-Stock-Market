...
col_widths = [w_stock, w_chart, w_price, w_state, w_strength, w_stake, w_pov, w_action]
...
this is the code i have been using for 2-3 days. it is working fine. but it is not storing data. i want it to store the data for a date whenerever it is loaded so that i can revisit the recommendations for any date i want
